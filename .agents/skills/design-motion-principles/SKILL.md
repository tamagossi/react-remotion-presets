...
### The Zajno Motion Vocabulary

Beyond the three designers, the [Zajno motion design framework](https://motion.zajno.com/) provides a universal vocabulary of 8 core animation techniques applicable to any motion work. Use these as building blocks:

| Technique | Description | When to Apply |
|---|---|---|
| **Easing** | Non-linear speed — acceleration and deceleration | Every animation. Never use linear. |
| **Offset & Delay** | Staggered timing between elements | Multi-element reveals, lists, grids |
| **Fade In/Fade Out** | Opacity transition | Simplest entrance/exit. Combine with other techniques. |
| **Transform & Morph** | Shape/state change | Transitions between scenes, icon-to-photo morphs |
| **Masking** | Reveal through shaped window | Photo reveals, text mask, wipe transitions |
| **Dimension** | Volume/depth cues | Premium product shots, floating card UIs |
| **Parallax** | Multi-speed depth layers | Atmospheric backgrounds, scroll-driven storytelling |
| **Zoom** | Camera move in/out | Scene transitions, product detail reveals |
...
| Educational video / e-learning | Jakub | Emil | Jhey (delighters only) |
| Language learning / shadowing | Jakub | Emil | Jhey (gamification) |
| Explainer / tutorial video | Jakub | Emil | — |
| Corporate presentation / instructional | Emil | Jakub | — |
