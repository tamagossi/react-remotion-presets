...
export const PillBounceChart: React.FC<PillBounceChartProps> = ({
	...
	const { durationInFrames: _durationInFrames, fps, height, width } = useVideoConfig();

	const totalFrames =
		animationDuration + holdDuration + exitDuration + staggerDelay * pills.length;
					...
					<React.Fragment key={i}>
						...
						<div
							style={{
								...
								width: ballSize,
								opacity:
									(frame > 25 + delay ? 1 : 0) * exitProgress,
							}}
						>
							<span
								style={{
