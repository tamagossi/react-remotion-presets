...
export const DonutBreakdownCardSchema = z.object({
	...
	centerSubtext: z.string().optional(),
	...
	segments: z.array(z.object({ color: zColor(), label: z.string(), percentage: z.number() })),
