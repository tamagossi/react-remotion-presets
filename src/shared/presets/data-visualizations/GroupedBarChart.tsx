...
export const GroupedBarChart: React.FC<GroupedBarChartProps> = ({
	...
	const totalFrames =
		animationDuration + holdDuration + exitDuration + staggerDelay * xLabels.length;
		...
		>
			...
			<div style={{ marginTop: 30, position: "relative" }}>
				...
				{xLabels.map((label, groupIndex) => {
					const groupX =
						chartLeft + groupGap + groupIndex * groupWidth;
				...
				>
					{series.map((s, i) => {
						const legendDelay =
							animationDuration + 10 + i * legendStaggerDelay;
