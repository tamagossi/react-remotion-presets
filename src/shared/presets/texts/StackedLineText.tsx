	...
	return (
		...
		>
			...
			const lineExitT = interpolate(
				...
				const size = Array.isArray(fontSize) ? fontSize[i] ?? fontSize[fontSize.length - 1] : fontSize;
				const weight = Array.isArray(fontWeight) ? fontWeight[i] ?? fontWeight[fontWeight.length - 1] : fontWeight;
