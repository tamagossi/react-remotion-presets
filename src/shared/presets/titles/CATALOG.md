...
**Description**
Inline text segments with per-segment control over font size, weight, style (italic/normal), and color. Segments flow horizontally on each line and animate with staggered entrance. Perfect for dynamic typography with mixed emphasis like "KNOWLEDGE _IS_ POWER".
