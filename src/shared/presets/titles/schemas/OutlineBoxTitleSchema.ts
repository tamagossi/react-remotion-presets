...
export const OutlineBoxTitleSchema = z.object({
	animationDirection: z.enum(["down", "left", "right", "up"]).optional(),
	animationDuration: z.number().optional(),
	boxBorderColor: zColor().optional(),
	boxBorderRadius: z.number().optional(),
	boxBorderThickness: z.number().optional(),
	boxColor: zColor().optional(),
	boxPadding: z.number().optional(),
